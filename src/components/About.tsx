      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            We're Ezra Hengeveld and Mahir, two passionate developers from Newfoundland, Canada. 
            Unlike typical coding businesses, we're a nonprofit organization dedicated to creating 
            exceptional websites while supporting families in need.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <div 
              key={index} 
              className="text-center p-6 rounded-lg bg-card shadow-soft hover:shadow-elevated transition-all duration-300 animate-scale-in"
